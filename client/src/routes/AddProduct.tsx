        ...
        <form action="">
          <div className="field">
            ...
            <div className="form-input">
              <input className='addproduct-input' type="text" placeholder='Name' required />
          ...
          <div className="field">
            ...
            <div className="form-input">
              <input className='addproduct-input' type="date" placeholder='Date Purchased' required />
          ...
          <div className="field">
            ...
            <div className="form-input">
              <input className='addproduct-input' type="number" min={0} step={0.01} placeholder='Price'/>
          ...
          <div className="field">
            ...
            <div className="form-input">
              <input className='addproduct-input' type="text" placeholder='Condition'/>
          ...
          <div className="field">
            ...
            <div className="form-input">
              <input className='addproduct-input' type="text" placeholder='Category' required />
              <FontAwesomeIcon className='addproduct-icon' icon={faTableCellsLarge} color='#BDA995' />
            </div>
          </div>

          <div className="field">
            <button id="addproduct-btn-submit">submit</button>
          </div>
        </form>
      </div>
    </div>
